...
export default function ComingSoon({headline,subheadline}: Props){return(
      ...
      <div className="relative px-6 py-10 overflow-hidden shadow-xl rounded-2xl bg-amber-500 sm:px-12 sm:py-20">
        <div aria-hidden="true" className="absolute inset-0 -mt-72 sm:-mt-32 md:mt-0">
          ...
          >
            ...
            />
            <path
              className="text-amber-600 text-opacity-40"
              fill="currentColor"
          ...
          <form action="#"  className="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
            <div className="flex-1 min-w-0">
              ...
              <input
                ...
                type="email"
                disabled
                className="block w-full px-5 py-3 text-base text-gray-900 placeholder-gray-500 border border-transparent rounded-md shadow-sm cursor-not-allowed dark:text-gray-50 dark:bg-gray-900 dark:placeholder-gray-400 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white dark:focus:ring-black focus:ring-offset-2 dark:focus:ring-offset-amber-400 focus:ring-offset-amber-500"
